...
;
	($.$hyoo_habhub) = class $hyoo_habhub extends ($.$mol_book2) {
		Theme(){
		...
		Menu_page(){
			...
			(obj.body) = () => ([(this.Search()), (this.Menu())]);
			return obj;
		}
		Details(id){
			const obj = new this.$.$mol_page();
			...
			(obj.body_scroll_top) = (next) => ((this.details_scroll_top(next)));
			(obj.body) = () => ([(this.Datails_text())]);
			return obj;
		}
		Menu_row(id){
			const obj = new this.$.$mol_link();
			(obj.minimal_height) = () => (40);
			(obj.sub) = () => ([(this.Menu_row_title(id))]);
			(obj.arg) = () => ((this.gist_arg(id)));
			return obj;
		}
	};
	($mol_mem(($.$hyoo_habhub.prototype), "Theme"));
	($mol_mem(($.$hyoo_habhub.prototype), "search_start"));
	($mol_mem(($.$hyoo_habhub.prototype), "Search_start"));
	($mol_mem(($.$hyoo_habhub.prototype), "Add_icon"));
	($mol_mem(($.$hyoo_habhub.prototype), "Add"));
	($mol_mem(($.$hyoo_habhub.prototype), "Source_link"));
	($mol_mem(($.$hyoo_habhub.prototype), "Lights"));
	($mol_mem(($.$hyoo_habhub.prototype), "search"));
	($mol_mem(($.$hyoo_habhub.prototype), "Details_body"));
	($mol_mem(($.$hyoo_habhub.prototype), "Search"));
	($mol_mem(($.$hyoo_habhub.prototype), "Menu"));
	($mol_mem_key(($.$hyoo_habhub.prototype), "Details_chat"));
	($mol_mem(($.$hyoo_habhub.prototype), "Created"));
	($mol_mem(($.$hyoo_habhub.prototype), "Details_link"));
	($mol_mem(($.$hyoo_habhub.prototype), "Close_icon"));
	($mol_mem(($.$hyoo_habhub.prototype), "Close"));
	($mol_mem(($.$hyoo_habhub.prototype), "details_scroll_top"));
	($mol_mem(($.$hyoo_habhub.prototype), "Datails_text"));
	($mol_mem_key(($.$hyoo_habhub.prototype), "Menu_row_title"));
	($mol_mem(($.$hyoo_habhub.prototype), "Menu_page"));
	($mol_mem_key(($.$hyoo_habhub.prototype), "Details"));
	($mol_mem_key(($.$hyoo_habhub.prototype), "Menu_row"));
