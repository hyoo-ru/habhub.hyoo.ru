...
declare namespace $.$$ {
    class $mol_text extends $.$mol_text {
        ...
        block_content(index: number): ($mol_dimmer | $mol_embed_native | $mol_text_code_row | $mol_link_iconed | $mol_text_span)[];
        ...
        line_content(path: readonly number[]): ($mol_dimmer | $mol_embed_native | $mol_text_code_row | $mol_link_iconed | $mol_text_span)[];
